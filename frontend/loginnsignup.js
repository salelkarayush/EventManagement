    ...
    <div class="bg-white p-8 rounded-lg shadow-md w-full max-w-md">
        ...
        <div id="login-form" class="form-container hidden">
            ...
            <form class="space-y-4">
                ...
                <button hx-post="" class="w-full bg-green-500 text-white px-4 py-2 rounded focus:outline-none hover:bg-green-700">Login</button>
            </form>
        </div>
        <div id="signup-form" class="form-container hidden">
            ...
            <form class="space-y-4">
                ...
                <button hx-post="" class="w-full bg-green-500 text-white px-4 py-2 rounded focus:outline-none hover:bg-green-700">Sign Up</button>
            </form>
        </div>
    </div>
    <script>
